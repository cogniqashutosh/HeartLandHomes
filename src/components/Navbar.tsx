...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white shadow-md">
      <div className="container-hh flex h-18 items-center justify-between py-3">
        ...
        {navLinks.map((link) => {
          ...
          return (
            <Link
              ...
              href={link.href}
              className={cn(
                "hidden rounded-full px-4 py-2 font-display text-[15px] text-black lg:inline-block",
                isActive ? "bg-navy-50 font-semibold" : "font-medium"
              )}
            >
              {link.label}
            </Link>
        ...
        <a
          ...
          className="hidden items-center gap-2 rounded-full bg-navy-50 py-1.5 pr-3 pl-1.5 font-display text-[15px] font-semibold text-navy-900 lg:flex"
        >
        ...
        <Link
          href="/contact"
          className="hidden items-center gap-2 rounded-full bg-gold-500 px-5 py-2.5 font-display text-[15px] font-semibold text-navy-900 shadow-sm transition-transform hover:scale-105 hover:bg-gold-400 lg:inline-flex"
        >
